// Pure render for <pura-prose>. No DOM; safe on server (SSR/DSD) and client.
import { EMPTY_SHIM } from "../base.js";

export function proseTemplate(el = EMPTY_SHIM) {
  const html = `<div part="prose" class="prose"><slot></slot></div>`;
  return { html, css: PROSE_CSS };
}
