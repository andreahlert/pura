// Pure render for <pura-input-group>. No DOM; safe on server (SSR/DSD) and client.
import { EMPTY_SHIM } from "../base.js";

export function inputGroupTemplate(el = EMPTY_SHIM) {
  ...
  return { html, css: INPUT_GROUP_CSS };
}

export const INPUT_GROUP_CSS = `
  :host { display: block; }
