...
import { runEject } from "../src/commands/eject.mjs";
...
try {
  ...
  else if (cmd === "eject") await runEject({ cwd, name: rest[0] });
  else { console.error("usage: pura <init|add|list|update|diff|remove|eject>"); process.exit(1); }
} catch (e) {
